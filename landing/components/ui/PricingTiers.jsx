...
/**
 * Reusable pricing tiers grid — no section wrapper.
 * Used standalone on the /pricing page. Framer-inspired layout: uniform
 * cards, price + limit chip, checklist, CTA pinned to bottom. Only the
 * CTA colour signals the featured tier. Keeps the sitewide glow-border
 * hover treatment.
 */
